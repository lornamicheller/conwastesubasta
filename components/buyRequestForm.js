...
class BuyRequestForm extends Component {
  static propTypes = {
    ...
    regionSelectChange: PropTypes.func.isRequired,
    projectSelectChange: PropTypes.func.isRequired,
    supervisorSelectChange: PropTypes.func.isRequired,
    selectedRegion: PropTypes.number.isRequired,
    selectedProject: PropTypes.number.isRequired,
    selectedSupervisor: PropTypes.number.isRequired,
      ...
      <Form className="row">
        <div className="col-12">
          ...
          <div className="row">
            <Input
              s={12}
              onChange={supervisorSelectChange}
